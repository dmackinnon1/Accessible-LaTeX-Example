...
\DocumentMetadata{
  ...
  pdfstandard = ua-2,
  tagging=on,
  check-tagging-status=listfiles, % outputs a summary of tagging status compatibility for loaded packages
  tagging-setup={
...
\end{verbatim}
\caption[The DocumentMetadata used in this document]{The \texttt{DocumentMetadata} used in this document}
\endgroup
\end{figure}
